        ...
        <Guest>
            ...
            <div className="container mx-auto flex flex-wrap flex-col md:flex-row items-start">
                <div className="flex flex-col w-full xl:w-2/5 justify-start lg:items-start overflow-y-hidden">
                    ...
                    <Link className="text-white text-center uppercase font-bold text-sm tracking-widest hover:bg-green-500 bg-green-400 rounded-md inline-block px-8 py-2 no-underline hover:no-underline" href="/scales">
                        Try for free
                    </Link>
                </div>
